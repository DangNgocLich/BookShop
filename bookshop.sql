...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 01, 2020 lúc 10:00 PM
...
--
-- RELATIONSHIPS FOR TABLE `chitiethoadonkho`:
--   `MAHOADON`
--       `hoadonnhapkho` -> `MAPHIEUNHAPKHO`
--   `MASP`
--       `sanpham` -> `MASP`
--
...
--
-- RELATIONSHIPS FOR TABLE `hoadonnhapkho`:
--   `MANV`
--       `nhanvien` -> `CMND`
--
...
('kinh di 2', '2.jpg', 'asdsadsa', '12345', 132, 3500, 100, 1000);
...
--
-- RELATIONSHIPS FOR TABLE `sukien`:
--
...
--
-- RELATIONSHIPS FOR TABLE `theloai`:
--
...
--
ALTER TABLE `hoadon`
  MODIFY `MAHOADON` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=84;

--
-- AUTO_INCREMENT cho bảng `hoadonnhapkho`
--
ALTER TABLE `hoadonnhapkho`
  MODIFY `MAPHIEUNHAPKHO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT cho bảng `theloai`
--
ALTER TABLE `theloai`
  MODIFY `MATL` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;
