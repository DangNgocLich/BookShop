  ...
  <tbody>
  	<tr class="item">
		...
		<td><button class="collapsible">Chọn</button>
			<div class="content">
				<form action="../hoadon/addhoadon" method="POST">
...
<div id="footer"><form action="../hoadon/hoantathoadon" method="POST"><button name="done">Done</button> <input type="hidden" name="mahoadon" id="mahoadon" value="<?php echo $mahoadon ?>"> <input type="hidden" name="tien" value="<?php echo $tien; ?>"> </form></div>
